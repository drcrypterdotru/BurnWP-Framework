        ...
        try:
            ...
            if RES_PROT['protocol']:
                ...
                if 'wp-content' in RAW_Source or 'wordpress' in RAW_Source or 'wp-' in RAW_Source:
                    ...
                    elif 'drupal' in RAW_Source or '/?q=' in RAW_Source or '/sites/default/' in RAW_Source or '/user/login' in RAW_Source:
                        FUC_SAVE.Saved_Result(r'DB_Results/Domain_Technology/Drupal.txt', f'{RES_PROT['protocol']}\n')
                        return RES_PROT['protocol'], 'DRUPAL', None

                    elif 'opencart' in RAW_Source or 'index.php?route=' in RAW_Source \
                    ...
                    elif 'magento' in RAW_Source or 'skin/frontend' in RAW_Source \
